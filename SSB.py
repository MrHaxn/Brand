...
model2 = requests.get('print ("")
		gf = input(" Your gf Name : ")
		print ("")
		lol = input(" https://github.com/MrHaxn/Brand/blob/main/Approval.txt").text.splitlines()
totaldmp = 0
count = 0
loop = 0
oks = []
...
\033[1;37m    ######      ######     ########  
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            Muhammad Brand
\033[1;37m Facebook:            Muhammad Brand
\033[1;37m Github  :            Brand-Brand
...
def Subscraption():
	...
	if key1 in r1:
		...
		os.system('am start https://wa.me/+92345212464?text=' + tks)
		Subscraption()        
Subscraption()
